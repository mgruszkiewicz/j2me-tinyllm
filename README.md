...
You need to setup LiteLLM server that is exposed to the internet using pure HTTP, then set `proxyUrl` and `proxyKey` in the code. Not sure if there is a good way to use env file during build time or other mean. PRs are welcome
